...
width: 100%;">
    ...
    <section style="display: block;">
        ...
        <p style="font-family: Poppins, Arial, Helvetica;">You're receiving this message because an account associated with this email has recently requested a password reset.</p>
